  ...
  const submit = (e) => {
    ...
    <div>
      ...
      <div style={styles.bar}>
        ...
        <br />
        <h1 className="h1" style={styles.editPage}>Post Edit Page (PostNo : {postNo})</h1>
        </div>
        <hr />
        {/* Post 내용 수정 입력 부분 */}
        <div>
        ...
        <div>
          ...
          />      
          <button style={styles.fileDeleteBotton}
                  onClick={() => deleteFileImage()} > 삭제 </button>  
          <div>사진 미리보기</div>
          <div align = "center">{fileImage && ( <img alt="sample" src={fileImage} 
